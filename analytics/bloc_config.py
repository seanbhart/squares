...
BLOC_DESCRIPTIONS = {
    'Postscarcity Front': 'Very progressive (purple-blue 0-1). Post-scarcity economics, UBI, automation-positive.',
    'Builder Corps': 'Pro-growth progressives (blue-green 1-2). Building state capacity, YIMBY, growth-oriented.',
    'Abundance Alliance': 'Growth coalition (blue-green-yellow 1-3). YIMBY, pro-immigration, pro-trade.',
    'Localist Alliance': 'Place-based politics (yellow-orange-red 3-5). Community-first, localist values.',
