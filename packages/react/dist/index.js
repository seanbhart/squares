...
function SquaresWidget({ onClose, primaryColor = "#4285f4" }) {
  ...
  const renderStep = () => {
    switch (step) {
      ...
      case 3:
        return /* @__PURE__ */ import_react.default.createElement("div", { style: { minHeight: "400px" } }, /* @__PURE__ */ import_react.default.createElement("h2", { style: { margin: "0 0 1rem 0", color: "#1a1a1a", fontSize: "1.8rem" } }, "Your Political Signature"), /* @__PURE__ */ import_react.default.createElement("div", { style: { textAlign: "center", margin: "2rem 0" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { fontSize: "clamp(2rem, 8vw, 3rem)", letterSpacing: "clamp(0.2rem, 1vw, 0.5rem)", marginBottom: "1rem", wordBreak: "break-all", lineHeight: "1.2" } }, emojiSignature), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", justifyContent: "center", gap: "clamp(0.5rem, 3vw, 2.5rem)", marginBottom: "2rem", flexWrap: "wrap" } }, POLICIES.map((p) => /* @__PURE__ */ import_react.default.createElement("span", { key: p.key, style: { fontSize: "0.85rem", color: "#666", fontWeight: 600, whiteSpace: "nowrap" } }, p.label)))), /* @__PURE__ */ import_react.default.createElement(
          "button",
          {
            onClick: handleCopy,
            style: {
