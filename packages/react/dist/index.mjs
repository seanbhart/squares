...
function SquaresWidget({ onClose, primaryColor = "#4285f4" }) {
  ...
  const renderStep = () => {
    switch (step) {
      ...
      case 3:
        return /* @__PURE__ */ React.createElement("div", { style: { minHeight: "400px" } }, /* @__PURE__ */ React.createElement("h2", { style: { margin: "0 0 1rem 0", color: "#1a1a1a", fontSize: "1.8rem" } }, "Your Political Signature"), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", margin: "2rem 0" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: "3rem", letterSpacing: "0.5rem", marginBottom: "1rem", wordBreak: "break-all" } }, emojiSignature), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "center", gap: "2.5rem", marginBottom: "2rem", flexWrap: "wrap" } }, POLICIES.map((p) => /* @__PURE__ */ React.createElement("span", { key: p.key, style: { fontSize: "0.85rem", color: "#666", fontWeight: 600, whiteSpace: "nowrap" } }, p.label)))), /* @__PURE__ */ React.createElement(
          "button",
          {
            onClick: handleCopy,
            style: {
...
function SquaresEmbedReact({
  ...
  return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement("div", { style: containerStyle }, /* @__PURE__ */ React2.createElement(
    ...
    /* @__PURE__ */ React2.createElement(
      ...
      /* @__PURE__ */ React2.createElement("div", { style: { fontSize: "32px", marginBottom: "12px", letterSpacing: "4px", textAlign: "center" } }, "\u{1F7E9}\u{1F7E6}\u{1F7E9}\u{1F7E7}\u{1F7EA}"),
      /* @__PURE__ */ React2.createElement("div", { style: { display: "flex", justifyContent: "space-between", fontSize: "11px", color: "#6b7280" } }, /* @__PURE__ */ React2.createElement("span", null, "Trade"), /* @__PURE__ */ React2.createElement("span", null, "Abortion"), /* @__PURE__ */ React2.createElement("span", null, "Migration"), /* @__PURE__ */ React2.createElement("span", null, "Economics"), /* @__PURE__ */ React2.createElement("span", null, "Rights"))
    ),
    /* @__PURE__ */ React2.createElement(
      "button",
      {
